...
if [[ "$OS" == "Linux" ]]; then
    if [[ "$ARCH" == "x86_64" ]]; then
        URL="https://github.com/Timmoth/aid-cli/releases/download/aid-0.1.11/aid-linux"
    else
    ...
    if [[ "$ARCH" == "x86_64" ]]; then
        URL="https://github.com/Timmoth/aid-cli/releases/download/aid-0.1.11/aid-mac"
        ...
        URL="https://github.com/Timmoth/aid-cli/releases/download/aid-0.1.11/aid-mac-arm"
    else
